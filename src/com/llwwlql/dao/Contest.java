...
public class Contest implements java.io.Serializable {
	...
	public String toString() {
		return "Contest [id=" + id + ", contestName=" + contestName
				+ ", orginId=" + orginId + ", startTime=" + startTime
				+ ", endTime=" + endTime + ", peopleNum=" + peopleNum
				+ ", origin=" + origin + ", contestType=" + contestType
